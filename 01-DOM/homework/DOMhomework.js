...
a.innerHTML = 'Aplicación creada por Martin';
...
var hh = buildToDos(toDoItems);
for(let i = 0; i < hh.length; i++){
  toDoContainer.appendChild(hh[i]);
}
}
...
function addToDo() {
  // Tu código acá:
var jj = document.querySelector('#toDoInput')
if(jj.value !== ''){
  let newToDo = new ToDo(jj.value);
